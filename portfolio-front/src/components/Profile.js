...
const Profile = () => {
    return (
        <div className="text-card">
            ...
            <p>
                Right now, I’m worked the most with React, Express, MongoDB, and a little bit in Node. However, I’ve worked with Angular, I’m studying and getting more familiar with both Java and C#. I’m very excited for this career path and learning as much as possible to be the best developer that I can be!
</p>
        </div>
    )
}
